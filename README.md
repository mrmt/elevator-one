...
**最新版: v1.4** — 変更点は [CHANGELOG.md](CHANGELOG.md) を参照。動かしているバージョンはヘッダーのタイトルの右にも出る。
